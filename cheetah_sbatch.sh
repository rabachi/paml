...
#SBATCH --job-name=mf_3_pend
#SBATCH --output=mf_3_pend_%j.log
#SBATCH --array=1-10
...
python parser.py --algo ac --model_type paml --model_size nn --hidden_size 128 --env HalfCheetah-v2 --max_actions 1000 \
                  --states_dim 27 --salient_states_dim 17 --num_iters 200 --real_episodes 1 --virtual_episodes 20 \
                  --batch_size 500 --num_action_repeats 1 --planning_horizon 10 --initial_model_lr 1e-3 --rhoER 0.5 \
                  --verbose 5 --rs $SLURM_ARRAY_TASK_ID --file_id 'critic10_hidden128_nnModel_'$SLURM_ARRAY_TASK_ID
...
python parser.py --algo ac --model_type paml --model_size constrained --hidden_size 2 --env Pendulum-v0 \
                  --max_actions 200 --states_dim 12 --salient_states_dim 3 --num_iters 200 --batch_size 250 \
                  ...
                  --file_id 'final_hidden2_rho0.25_real5_virt500_critic0extraeps_constrainedModel_'$SLURM_ARRAY_TASK_ID

python parser.py --algo ac --model_type mle --model_size nn --env HalfCheetah-v2 --hidden_size 128 --max_actions 1000 \
                  --states_dim 17 --salient_states_dim 17 --num_iters 2000 --real_episodes 1 --virtual_episodes 20 \
                  --batch_size 250 --num_action_repeats 1 --planning_horizon 10 --initial_model_lr 1e-5 --rhoER 0.5 \
                  --verbose 5 --rs $SLURM_ARRAY_TASK_ID --file_id 'critic0_hidden128_nnModel_'$SLURM_ARRAY_TASK_ID
...
python parser.py --algo ac --model_type mle --model_size constrained --hidden_size 2 --env Pendulum-v0 \
                            ...
                            --planning_horizon 5 --initial_model_lr 1e-4 --rhoER 0.25 --rs $SLURM_ARRAY_TASK_ID \
                            --file_id 'final_constrainedModel_'$SLURM_ARRAY_TASK_ID
...
python parser.py --algo ac --model_type model_free --env HalfCheetah-v2 --max_actions 1000 --states_dim 47 \

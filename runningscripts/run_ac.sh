...
do
	...
	# python parser.py --algo ac --model_type mle --model_size $model --hidden_size 1 --env lin_dyn --max_actions 200 --states_dim 2 --salient_states_dim 2 --num_iters 1500 --real_episodes 1 --initial_model_lr 1e-4 --virtual_episodes 100 --num_action_repeats 1 --planning_horizon 10 --batch_size 128 --rhoER 0.25 --rs $file_id --file_id 'final_'$model'Model_'$file_id &

	# python parser.py --algo ac --model_type model_free --env lin_dyn --max_actions 200 --states_dim 2 --salient_states_dim 2 --num_action_repeats 1 --verbose 1 --save_checkpoints_training True --rs $file_id --file_id 'final_'$model'Model_'$file_id &
	...
	# python parser.py --algo ac --model_type paml --model_size $model --hidden_size 1 --env lin_dyn --max_actions 200 --states_dim 2 --salient_states_dim 2 --num_iters 200 --real_episodes 1 --initial_model_lr 1e-3 --virtual_episodes 100 --num_action_repeats 1 --planning_horizon 10 --batch_size 128 --rhoER 0.25 --rs $file_id --file_id 'final_'$model'Model_'$file_id &
	
	# /h/abachiro/.local/bin/mprof run -o 'pend_mle_largedataset.dat' python parser.py --algo ac --model_type mle --model_size $model --hidden_size 2 --env Pendulum-v0 --max_actions 200 --num_iters 1000 --batch_size 250 --states_dim 120 --salient_states_dim 3 --real_episodes 5 --virtual_episodes 500 --num_action_repeats 1 --planning_horizon 5 --initial_model_lr 1e-4 --rhoER 0.25 --rs $file_id & #--file_id 'final_hidden2_rho0.25_real5_virt500_critic0extraeps_'$model'Model_'$file_id &
	...
	python parser.py --algo ac --model_type paml --model_size $model --hidden_size 2 --env Pendulum-v0 --max_actions 200 --states_dim 120 --salient_states_dim 3 --num_iters 200 --batch_size 250 --real_episodes 5 --virtual_episodes 500 --num_action_repeats 1 --planning_horizon 5 --initial_model_lr 1e-3 --rhoER 0.25 --rs $file_id --file_id 'final_hidden2_rho0.25_real5_virt500_critic0extraeps_'$model'Model_'$file_id &

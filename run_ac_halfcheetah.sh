...
do
	...
	python parser.py --algo ac --model_type paml --ensemble 1 --model_size $model --hidden_size 3 --env dm-Walker-v0 --max_actions 1000 --states_dim 24 --salient_states_dim 24 --num_iters 200 --real_episodes 1 --virtual_episodes 20 --num_action_repeats 1 --planning_horizon 3 --initial_model_lr 1e-3 --rhoER 0.5 --batch_size 500 --rs $file_id --file_id 'rho0.5_virt20_'$model'Model_'$file_id &
	...
	# python parser.py --algo ac --model_type mle --model_size nn --hidden_size 3 --env HalfCheetah-v2 --max_actions 1000 --states_dim 27 --salient_states_dim 17 --num_iters 2000 --real_episodes 1 --virtual_episodes 20 --batch_size 250 --num_action_repeats 1 --planning_horizon 3 --initial_model_lr 1e-5 --rhoER 0.5 --verbose 5 --rs $file_id --file_id $model'Model_'$file_id &

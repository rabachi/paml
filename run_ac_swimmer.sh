...
do
	...
	python parser.py --algo ac --model_type paml --model_size $model --hidden_size 3 --env Swimmer-v2 --max_actions 200 --states_dim 8 --salient_states_dim 8 --num_iters 400 --real_episodes 1 --virtual_episodes 80 --num_action_repeats 1 --planning_horizon 3 --initial_model_lr 1e-3 --rhoER 0.5 --rs $file_id --file_id 'rho0.5_virt80_'$model'Model_'$file_id &

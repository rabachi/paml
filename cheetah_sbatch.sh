...
#SBATCH --job-name=paml6_pend
#SBATCH --output=paml6_pend_%j.log
#SBATCH --array=1-10
...
#                   --states_dim 34 --salient_states_dim 17 --num_iters 200 --real_episodes 1 --virtual_episodes 10 \
#                   --batch_size 500 --num_action_repeats 1 --planning_horizon 5 --initial_model_lr 1e-3 --rhoER 0.5 \
#                   --verbose 5 --noise_type redundant --rs $SLURM_ARRAY_TASK_ID --file_id 'lin_redundant_fid_'$SLURM_ARRAY_TASK_ID
...
#                   --states_dim 34 --salient_states_dim 17 --num_iters 2000 --real_episodes 1 --virtual_episodes 10 \

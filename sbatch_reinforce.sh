...
#SBATCH --job-name=reinforce_mle_50_traj200
#SBATCH --output=reinforce_mle_50_traj200_%j.log
#SBATCH --array=1-10
...
echo Running reinforce experiments... reinforce_mle_states50_traj200
